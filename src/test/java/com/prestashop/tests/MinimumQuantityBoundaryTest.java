...
public class MinimumQuantityBoundaryTest extends BaseTest {

    @Test
    public void verifyMinimumQuantityBoundaryAccepted() {
        ...
        Assert.assertEquals(
                clothesPage.getProductQuantity(productName),
                "1",
                "Minimum quantity was not set correctly."
        );
        ...
        Assert.assertEquals(
                cartPage.getProductQuantity(productName),
                "1",
